local l = loadstring(game:HttpGet("https://raw.githubusercontent.com/DINERO9/Array/main/unk", true))()
l:Notify("TeTraX-Official Executed!","WARNING",10)
...
tab.newSlider("HitBox Expander", "Melee", 70, false, function(num)
    _G.HeadSize = (num)
    _G.Disabled = true
...
tab.newButton("Invisible", "", function()
           --[[Invisibility Toggle
...
local tab = DrRayLibrary.newTab("Player", "")

plr = {}
for i,v in pairs(game:GetService("Players"):GetChildren()) do
    table.insert(plr,v.Name)
end
tab.newDropdown("Players", "Select player to teleport", plr , function(selectedPlayer)
...
tab.newToggle("Auto TP", "Loop teleport to player", true, function(selectedPlayer)
    _G.TPPlayer = selectedPlayer
