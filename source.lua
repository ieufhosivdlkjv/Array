...
--Slider Color
        ...
        local customsliderco = Instance.new("UIGradient",custom)
        customsliderco.Color = ColorSequence.new(
...
local function Hide(notify: boolean?)
	...
	if notify then
		if useMobilePrompt then 
			RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping 'HomeIcon'.", Duration = 3, Image = 4400697855})
		else
			RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by pressing K.", Duration = 3, Image = 4400697855})
		end
	end
