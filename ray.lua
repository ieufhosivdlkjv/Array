...
windowName.Position = UDim2.new(0, 10,10 ,10)
windowName.Size = UDim2.new(0, 418, 0, 34)
windowName.Parent = topbar

local PlayerImage = Instance.new("ImageLabel")
PlayerImage.Name = "PlayerImage"
PlayerImage.Image = game:GetService("Players"):GetUserThumbnailAsync(game:GetService("Players").LocalPlayer.UserId, Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size100x100)
